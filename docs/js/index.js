...
var accordion = document.body.querySelector('.index-accordion');
var accordionItems = accordion.querySelectorAll('.index-accordion__item');
var accordionActivators = accordion.querySelectorAll('.index-accordion__activator');
var textContents = accordion.querySelectorAll('.text-contents');
var initServicesAccordion = function initServicesAccordion() {
  ...
  textContents.forEach(function (item, index) {
    new perfect_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"](item, {
      minScrollbarLength: 40,
      wheelSpeed: 0.1
    });
  });
  function openContent(index) {
    ...
    (_accordion$querySelec = accordion.querySelector('.index-accordion__item.index-accordion__item--active')) === null || _accordion$querySelec === void 0 || _accordion$querySelec.classList.remove('index-accordion__item--active');
...
/***/ "./src/blocks/modules/sliders/certificates/certificates-slider.js":
/*!************************************************************************!*\
  !*** ./src/blocks/modules/sliders/certificates/certificates-slider.js ***!
  \************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _modules_sliders_certificates_certificates_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! %modules%/sliders/certificates/certificates-slider */ "./src/blocks/modules/sliders/certificates/certificates-slider.js");
/* harmony import */ var _modules_sliders_works_works_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! %modules%/sliders/works/works-slider */ "./src/blocks/modules/sliders/works/works-slider.js");
...
/* harmony import */ var _modules_sliders_viewers_viewers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! %modules%/sliders/viewers/viewers */ "./src/blocks/modules/sliders/viewers/viewers.js");
/* harmony import */ var _modules_services_accordion_services_accordion__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! %modules%/services-accordion/services-accordion */ "./src/blocks/modules/services-accordion/services-accordion.js");
/* harmony import */ var _modules_works_accordion_works_accordion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! %modules%/works-accordion/works-accordion */ "./src/blocks/modules/works-accordion/works-accordion.js");
...
/* harmony import */ var _import_index_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./import/index-page */ "./src/js/import/index-page.js");
